    ...
    <div className="flex min-h-screen">
      <section className="hidden lg:flex lg:w-1/2 relative flex-col justify-between p-16 overflow-hidden bg-gradient-to-br from-surface to-primary-dim">
        <div className="relative z-10">
          ...
          <h2 className="headline-font text-4xl font-bold text-white mb-4">Start Your Journey</h2>
          <p className="text-on-surface-variant text-lg">Create your student account and begin earning rewards for academic excellence</p>
        </div>
      ...
      <section className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-surface-container">
        <div className="w-full max-w-md">
          <h3 className="headline-font text-2xl font-bold text-on-surface mb-8">Student Registration</h3>
          <form className="space-y-4">
            <input type="text" placeholder="Full name" className="w-full px-4 py-3 bg-surface border border-outline-variant rounded-lg text-on-surface placeholder-on-surface-variant focus:outline-none focus:border-primary" />
            ...
            <input type="password" placeholder="Confirm password" className="w-full px-4 py-3 bg-surface border border-outline-variant rounded-lg text-on-surface placeholder-on-surface-variant focus:outline-none focus:border-primary" />
          ...
          <div className="mt-6 text-center">
            <p className="text-on-surface-variant">Already have an account? <Link to="/student/login" className="text-primary hover:underline">Login here</Link></p>
