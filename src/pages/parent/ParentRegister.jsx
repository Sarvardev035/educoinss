    ...
    <div className="flex min-h-screen">
      <section className="hidden lg:flex lg:w-1/2 relative flex-col justify-between p-16 overflow-hidden bg-gradient-to-br from-surface to-secondary-dim">
        <div className="relative z-10">
          ...
          <h2 className="headline-font text-4xl font-bold text-white mb-4">Join Parent Community</h2>
          <p className="text-on-surface-variant text-lg">Create an account and start monitoring your child's academic progress</p>
        </div>
      ...
      <section className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-surface-container">
        <div className="w-full max-w-md">
          <h3 className="headline-font text-2xl font-bold text-on-surface mb-8">Parent Registration</h3>
          <form className="space-y-4">
            <input type="text" placeholder="Full name" className="w-full px-4 py-3 bg-surface border border-outline-variant rounded-lg text-on-surface placeholder-on-surface-variant focus:outline-none focus:border-secondary" />
            ...
            <input type="password" placeholder="Confirm password" className="w-full px-4 py-3 bg-surface border border-outline-variant rounded-lg text-on-surface placeholder-on-surface-variant focus:outline-none focus:border-secondary" />
          ...
          <div className="mt-6 text-center">
            <p className="text-on-surface-variant">Already have an account? <Link to="/parent/login" className="text-secondary hover:underline">Login here</Link></p>
